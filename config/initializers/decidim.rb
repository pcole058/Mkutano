...
Decidim.configure do |config|
  ...
  config.application_name = "mkutano.community"
  config.mailer_sender = "MKUTANO Team <administration@mkutano.community>"
  config.throttling_max_requests = 5000
  config.throttling_period = 1.minutes
  ...
  # Currency unit
  config.currency_unit = ENV.fetch("DECIDIM_CURRENCY_UNIT", "CHF")

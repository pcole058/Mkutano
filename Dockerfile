FROM git.octree.ch:4567/decidim/vocacity/system/decidim-0.26
...
COPY ./contrib/01_mkutano_entrypoint /usr/local/share/docker-entrypoint.d/01_mkutano_entrypoint
